            ...
            },
            {
              ...
              children: [
                ...
                },
                {
                  ...
                  meta: { title: '安全设置', invisible: true, keepAlive: true, }
                },
                {
                  path: 'Personalization',
                  name: '个性化设置',
                  component: () => import('@/pages/account/settings/Custom'),
                  meta: { title: '个性化设置', invisible: true, keepAlive: true, }
                },
                {
                  path: 'AccountBinding',
                  name: '账户绑定',
                  component: () => import('@/pages/account/settings/Binding'),
                  meta: { title: '账户绑定', invisible: true, keepAlive: true, }
                },
                // {
                //   path: '/account/settings/notification',
                //   name: '新消息通知',
                //   component: () => import('@/pages/account/settings/Notification'),
                //   meta: { title: '新消息通知', invisible: true, keepAlive: true, }
                // }
              ]
            }
          ]
