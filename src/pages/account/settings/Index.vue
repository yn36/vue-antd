        ...
        <div class="account-settings-info-left">
          ...
          >
            <a-menu-item key="/account/PersonalSettings/BasicSettings">
              <router-link to="/account/PersonalSettings/BasicSettings">{{$t('BasicSettings')}}</router-link>
            </a-menu-item>
            ...
            <a-menu-item key="/account/PersonalSettings/Personalization">
              <router-link to="/account/PersonalSettings/Personalization">{{$t('Personalization')}}</router-link>
            </a-menu-item>
